...
$lang->action->desc->bugconfirmed   = '$date, 由 <strong>$actor</strong> 通过审核，Bug已解决。' . "\n";
$lang->action->desc->bugsuspend     = '$date, 由 <strong>$actor</strong> 挂起Bug。' . "\n";
$lang->action->desc->bugrecheck     = '$date, 由 <strong>$actor</strong> 审核不通过。' . "\n";
...
$lang->action->label->resolved            = '解决了Bug，申请审核中';
$lang->action->label->reviewed            = '评审了';
$lang->action->label->moved               = '移动了';
$lang->action->label->confirmed           = '确认了需求，';
$lang->action->label->bugconfirmed        = '通过了审核';
$lang->action->label->bugrecheck          = '驳回了审核';
$lang->action->label->bugsuspend          = '挂起了Bug';
...
$lang->action->label->editestimate        = '编辑工时';
