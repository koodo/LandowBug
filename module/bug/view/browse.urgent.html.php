      ...
      <td>
          <div class="ldBuglist">
              <div class="ldbTitle">
                  <i class="icon-bug-s1"></i>
                  <span>紧急待处理的BUG</span>
                  <a class="btn-more" href="<?php echo helper::createLink('bug', 'browse', "productid=$productID&browseType=urgent&param=0"); ?>">更多...</a>
              </div>
        <table class='table-1 fixed colored tablesorter datatable buglist' id='bugList'>
          ...
          <tr class='colhead'>
            ...
            <!-- 处理人 -->
            <!--<th colspan="2" ><?php common::printOrderLink('assignedTo',       $orderBy, $vars, '处理人');?></th>-->
            <th colspan="1">处理人</th>
          ...
          <tbody>
          <?php foreach($bugs_urgent as $bug):?>
