...
<script type="text/javascript" src="<?php echo $jsRoot;?>ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="<?php echo $jsRoot;?>ueditor/ueditor.all.js"></script>
<script type="text/javascript" src="<?php echo $jsRoot;?>ueditor/lang/zh-cn/zh-cn.js"></script>
