...
$config->mail->turnon      = true;         // trun on email feature or not. true|false
$config->mail->fromAddress = 'bug@landowsoft.com';            // The from address.
$config->mail->fromName    = 'Landow';      // The from name.
...
$config->mail->smtp->host     = 'smtp.exmail.qq.com';// The smtp server host address.
$config->mail->smtp->port     = '25';       // The smtp server host port.
$config->mail->smtp->secure   = '';         // The type to encode datas, 'ssl' or 'tls' allowed
$config->mail->smtp->username = 'bug@landowsoft.com';         // The smtp user, may be a full email adress.
$config->mail->smtp->password = 'landow2012';         // The smtp user's password.
