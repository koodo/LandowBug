...
<table class='table-1 colored fixed'>
  ...
  foreach($actions as $action)
  {
      ...
      $objectLabel = $action->objectLabel == 'Bug' ? '' : $action->objectLabel;
      echo "<tr><td class='nobr' width='95%'>";
      printf($lang->my->home->action, $action->date, $user, $action->actionLabel, $objectLabel, $action->objectLink, $action->objectName);
