...
class productModel extends model
{
    ...
    public function select($products, $productID, $currentModule, $currentMethod, $extra = '')
    {
        ...
        #$selectHtml = html::select('LD-product-list', $products, $productID, "class=\"nav2select\" onchange=\"productSelectClick(this.value, '$currentModule', '$currentMethod', '$extra');\"");
        #return $selectHtml;
