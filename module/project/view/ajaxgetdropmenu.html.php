...
<input type='text' class='gray' id='search' value='' onkeyup='searchItems(this.value, "project", projectID, module, method, extra, event)' placeholder='<?php echo $this->app->loadLang('search')->search->common;?>' />
